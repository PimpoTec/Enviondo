...
const Icons = (() => {
  ...
  return {
    ...
    maximize: (s) => svg('<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M16 3h3a2 2 0 0 1 2 2v3"/><path d="M8 21H5a2 2 0 0 1-2-2v-3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>', s),
    ...
    users: (s) => svg('<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20c0-3.6 3-6 6.5-6s6.5 2.4 6.5 6"/><path d="M16.5 4.8a3.5 3.5 0 0 1 0 6.7"/><path d="M18 14.3c2.5.6 4 2.6 4 5.7"/>', s),
    tag(name, text) {
