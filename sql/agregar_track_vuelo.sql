...
-- volado (lista de puntos [lat, lon]), a partir de un archivo .csv o .kml
-- que se puede descargar de FlightRadar24 para un vuelo con transponder
-- ADS-B. Se parsea del lado del cliente al cargar/editar el vuelo (no hace
-- falta ningún servicio externo ni Storage) y se guarda ya como puntos,
